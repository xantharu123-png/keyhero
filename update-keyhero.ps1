# update-keyhero.ps1
# Dieses Skript überschreibt UI-Dateien (globals.css, Header.tsx, page.tsx)
# und schreibt die aktuellste Version hinein.
...
Write-Host "Jetzt bitte:" -ForegroundColor Cyan
Write-Host "  git add ." -ForegroundColor Gray
Write-Host "  git commit -m 'apply ui update via script'" -ForegroundColor Gray
